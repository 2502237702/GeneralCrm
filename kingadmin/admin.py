...
from audit import models as audit_model
...
class StepAdmin(BaseKingAdmin):
    list_display = ['flow_template','name','order','role']
    list_filter = ['flow_template',]


class FlowRecordAdmin(BaseKingAdmin):
    list_display = ['flow','step','user','status','date','comment']
    list_filter = ['flow','status']


site.register(audit_model.FlowTemplate)
site.register(audit_model.Flow)
site.register(audit_model.Step,StepAdmin)
site.register(audit_model.FlowRecord,FlowRecordAdmin)
site.register(audit_model.FlowRole)
site.register(audit_model.FlowBecome_Full_Staff)
site.register(audit_model.FlowLoan)
site.register(audit_model.FlowTrip)
site.register(audit_model.FlowVaction)
...
site.register(stu_model.Account, StuAccountAdmin)
