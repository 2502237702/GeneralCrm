    ...
    for row_data in editable_data:
        ...
        try:
            if obj_id:
                ...
                model_form = forms.create_form(admin_class.model, list(row_data.keys()), admin_class, request=request,
                                               partial_update=True)
...
def password_reset_form(request, app_name, table_db_name, user_id):
    ...
    if can_change_user_password:
        ...
        return render(request, 'kingadmin/password_change.html', {'user_obj': user_obj, 'form': change_form})
