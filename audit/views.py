...
def my_application(request):
    ...
    return render(request,"audit/my_application.html")


@login_required
def flow_detail(request,flow_id):
    flow_obj = models.Flow.objects.get(id=flow_id)
    return render(request,"audit/flow_detail.html", locals())
...
def my_approvals(request):
    ...
    return render(request,"audit/my_approvals.html", locals())


def my_approval_records(request):
    """我的审批记录页"""

    return render(request,"audit/my_approval_records.html", locals())
...
def flow_examination(request,record_id):
    ...
    return render(request,"audit/flow_examination.html",locals())
